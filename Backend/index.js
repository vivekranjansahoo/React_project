...
app.post('/productregister', async (req, res) => {
  ...
  app.post('/orderdetails', async (req, res) => {
    try {
      const { name,country,streetaddress,city,state,pincode,phoneno,email,paymentmethod,billno,productdata } = req.body;
      const newOrder = new Order({ name,country,streetaddress,city,state,pincode,phoneno,email,paymentmethod,billno,productdata });
      await newOrder.save();
