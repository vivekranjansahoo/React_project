...
app.post('/productregister', async (req, res) => {
    try {
      ...
      const newProduct = new Product({ name,image, desc,catagory,color, price });
  ...
  app.post('/orderdetails', async (req, res) => {
    try {
      const { name,country,streetaddress,city,state,pincode,phoneno,email,paymentmethod,billno,productdata,ammount } = req.body;
      const newOrder = new Order({ name,country,streetaddress,city,state,pincode,phoneno,email,paymentmethod,billno,productdata,ammount });
